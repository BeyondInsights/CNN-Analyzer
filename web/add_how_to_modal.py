...
state_addition = '''  const [showHowToModal, setShowHowToModal] = useState(false);
'''

# Find where to add the state (after other state declarations)
content = re.sub(
    r'(const \[showAttributeImpact, setShowAttributeImpact\] = useState\(false\);)',
    r'\1\n' + state_addition,
    content
)
...
# Add button after Clear All Selections
content = re.sub(
            ...
            <div style={{ padding: '30px' }}>
              ...
              <div style={{ marginBottom: '30px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '15px' }}>
                  ...
                  <div style={{ padding: '15px', background: '#fff3e0', borderRadius: '6px' }}>
                    <strong style={{ color: '#f57c00' }}>📊 Bundle Strategy</strong>
                    <p style={{ fontSize: '14px', marginTop: '5px' }}>Bundle vs individual insights</p>
                  </div>
                  <div style={{ padding: '15px', background: '#f3e5f5', borderRadius: '6px' }}>
                    <strong style={{ color: '#7b1fa2' }}>📈 Attribute Impact</strong>
                    <p style={{ fontSize: '14px', marginTop: '5px' }}>Feature importance analysis</p>
                  </div>
                  <div style={{ padding: '15px', background: '#e0f2f1', borderRadius: '6px' }}>
                    <strong style={{ color: '#00796b' }}>💾 Download Report</strong>
                    <p style={{ fontSize: '14px', marginTop: '5px' }}>Export to CSV</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ background: '#f8f9fa', padding: '20px', borderRadius: '8px' }}>
                  <p style={{ marginBottom: '10px' }}><strong>TAM Universe:</strong> 105,624,640 U.S. households</p>
                  <p style={{ marginBottom: '10px' }}><strong>ANY PRODUCT:</strong> Total reach across all products (Tiered mode)</p>
                  <p style={{ marginBottom: '10px' }}><strong>Demographics:</strong> Gender, Age (18-34, 35-54, 55-74), Linear TV, CNN engagement</p>
                  <div style={{ marginTop: '15px', padding: '15px', background: '#fff3cd', borderRadius: '6px' }}>
                    <strong style={{ color: '#856404' }}>💡 Pro Tip:</strong> 35-54 age group typically shows highest conversion. 
                    Occasional CNN viewers often convert better than regular viewers.
                  </div>
                </div>
              </div>
...
# Add modal before the closing div of the main component
content = re.sub(
    r'(</div>\s*\);\s*})',
    modal_component + r'\n\1',
    content
...
print("✓ Added beautiful How to Use modal")
