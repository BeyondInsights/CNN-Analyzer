              ...
              {profileProducts.map(product => (
                ...
                >
                  ...
                  <Label htmlFor={`profile-product-${product.id}`} className="text-center cursor-pointer">
                    <span className="font-semibold">{product.product || `Product ${product.id}`}</span><br/> 
                    {/* Displaying product.product as the main name, assuming 'name' field might not exist on ProductSetupConfig as used here */}
